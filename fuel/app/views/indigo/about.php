            ...
            <div class="left">
                <div class="grid-child right">
                    <ul><h2> Connor Quick </h2>
                        <h4 style="margin-top: -15px; margin-bottom: -1px">Lead Engineer</h4>
            ...
            <div class="left">
                <div class="grid-child left">
                    <ul><h2> Matthew Mattson </h2>
                        <h4 style="margin-top: -15px; margin-bottom: -1px">Front End Engineer</h4>
                        <li> Computer Science Major with an open outlook on specializations</li>
                        <li> Father of Two</li> <br>
    ...
    <section>
        <div class="grid-container">
            ...
            <div class="left">
                <div class="grid-child right">
                    <ul><h2> Max Fink </h2>
                        <h4 style="margin-top: -15px; margin-bottom: -1px">Back End Engineer</h4>
